...
run-shell "PATH=\$PATH:${pythonWithPowerline}/bin:${sysstat}/bin ${pythonWithPowerline}/bin/powerline-daemon -q &> /dev/null; return 0"
...
run-shell "PATH=\$PATH:${pythonWithPowerline}/bin:${sysstat}/bin ${pythonWithPowerline}/bin/powerline-config tmux setup &> /dev/null; return 0"
